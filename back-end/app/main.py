...
from app.api.routes import admin, applications, auth, health, keys, sdu_auth, secondary, templates, venues
...
def create_app() -> FastAPI:
    ...
    app.include_router(secondary.router, prefix=settings.api_v1_prefix)
